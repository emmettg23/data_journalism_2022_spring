...
**A3** The zip code 20850 had the largest sum of PPP loans, a total value of \$474525058. The count for 20850's loans is 474525058.
```{r}
...
**A5** When we  previously scrutinized this data, we determined that a large number of applicants omitted the "race" portion of the PPP application. It is likely that this discrepancy orginates from this frequent omission.
