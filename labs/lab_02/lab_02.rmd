...
Most West Virginia PPP loans were between \$10,000 and \$50,000.
...
Davis & Trust Company, Miners & Merchants Bank.

```{r}
# Write the code to produce your answer here
wv_undisbursed_loans <- west_virginia_ppp %>% filter(undisbursed_amount > 0)
...
Loans might not be paid out if a business files for bankruptcy or closes permanently. Or, if the lending company goes out of business. Or perhaps if the lending company was committing fraud and their assets were frozen. I guess the ultimate question I am getting at is: Was there a legal problem or business problem for the lender that inhibited their ability to distribute loan funds?
...
**A5**
10. J. AUSTIN HEATING & COOLING, INC. on April 8, 2022.

```{r}
# Write the code to produce your answer here
 wv_max_jobs <- west_virginia_ppp %>% filter( jobs_retained == 500)
