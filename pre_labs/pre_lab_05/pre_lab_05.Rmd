...
**Answer**
Cities with varying capitalization in their name are not paired with cities of the same spelling, but different capitalization.
```{r}
...
**Answer**
Changed capitalization of some cities from all caps to mostly lowercase, changed capitalization of some cities from lowercase to all caps. 
...
**Answer**
Changed cities in all caps to first letter capitalized then the rest lowercase, changed cities in lowercase to all caps, maintained cities without discrepancies in their original form.
```{r}
cleaned_md_loans %>%
...
**Answer**
Capitalization is slightly more uniform. There are not as many outliers left in all lowercase or all caps like in the previous tibble. Overall, most city names have their first letter capitalized and the rest lowercase.
